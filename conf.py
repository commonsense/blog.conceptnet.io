...
BLOG_AUTHOR = "Robyn Speer"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("//www.conceptnet.io", "Explore ConceptNet"),
...
FILTERS = {
   ".html": [filters.typogrify, filters.add_header_permalinks, filters.html_tidy_nowrap],
...
# is in the manual.
COMMENT_SYSTEM_ID = "conceptnet-blog"
...
DEPLOY_FUTURE = True    # don't tell me what to do
